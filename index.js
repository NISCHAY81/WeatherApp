...
// let oldTab = userTab;
// const API = "168771779c71f3d64106d8a88376808a";
...
//      if(!SearchFrom.classList.contains("acitve")){
//       //kya search form wala contaier is invisible, if yes then make it visible
//       userInfoContainer.classList.remove("active");
//       grantAccessContainer.classList.remove("active");
//       //ab main your weather tab me aa gaya hu, toh weather bhi display krna padega , so let's check the local storage frist
//       // for co-ordinates, if we have saved them there.
//       SearchFrom.classList.add("active");
//      }
//      else{
//       //main pahle search tab pr tha, ab your weather tab visible krna hai
